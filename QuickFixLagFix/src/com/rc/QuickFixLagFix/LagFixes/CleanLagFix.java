...
public class CleanLagFix extends LagFix {
	...
	public String IsEnabled(Context ApplicationContext) throws Exception, Error {
		...
		boolean HasEXT2File = new File("/data/linux.ex2").exists();
		
		if (!HasLagfixInstalled && HasEXT2File)
			return ENABLED;
